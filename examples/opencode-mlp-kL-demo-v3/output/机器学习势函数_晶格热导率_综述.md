...
**GAP/HDNNP 定义了精度与奠基地位。** HDNNP 在硅与 GaN 上把力 RMSE 压到 40 meV/Å 以下，热导率偏差控制在 5% 以内，确立了“MLIP $\approx$ DFT 代理”的基准。[3] GAP 通过高斯过程回归以相对较少的结构训练非晶硅势，兼顾晶态与非晶两种相的 $\kappa$ 预测，成为后续 GAP 系在元素半导体上的代表。[11] 此后大量 NEP/MTP 工作都以这类早期精度验证为对照。

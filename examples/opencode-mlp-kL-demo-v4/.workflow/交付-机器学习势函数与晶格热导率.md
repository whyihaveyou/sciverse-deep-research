...
|---|---|---|---|---|---|
| Mortazavi2020MTP | 被动学习 MTP $\rightarrow$ ShengBTE | DFT-AIMD 短轨迹 | 多体相/2D 材料 | 良好 | BTE 路线奠基 |
...
| Mortazavi2020C3N | 被动 MLIP | NEMD | C₃N 单层 | $\kappa$≈418 W/(m·K)，调和分歧 |
...
| 体系 | MLIP/方法 | 四声子对 $\kappa$ 的影响 | 为何载决 |
|---|---|---|---|
